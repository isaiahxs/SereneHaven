                    ...
                    <div className='spots-container'>
                        <p className='loc'>
                            ...
                            <span className='rating'>
                                {/* in real site, they sometimes have ratings show two decimal places */}
                        ...
                        {/* in wireframes, they would rather have us show name in tooltip, but in real site, they have `x Views`, but we don't have that in our backend so i'll have the spot's name for right now*/}
